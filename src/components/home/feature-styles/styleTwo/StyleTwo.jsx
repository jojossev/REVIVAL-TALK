...
const StyleTwo = ({ Data }) => {
  ...
  return (
    ...
    <>
      ...
      {/* rss-feeds-news section starts from here   */}
      {Data && Data.rss_feeds_news?.length > 0 &&
        <div className='styleTwo container'>

          <section className=''>
            <StylesTitleDiv title={Data && Data.title} desc={Data && Data.short_description} link={`/${currLangCode}/rss-feed/`} feedCateIds={Data?.category_ids} />

            <div className="grid lg:grid-cols-8 gap-5">
              <div className='grid lg:grid-cols-1 gap-5 lg:col-span-2'>
                <>
                  <StyleTwoCard Data={Data.rss_feeds_news[0]} breakingNewsCard={true} rssFeedCard={true} />
                  <StyleTwoCard Data={Data.rss_feeds_news[1]} breakingNewsCard={true} rssFeedCard={true} />
                </>
              </div>
              <div className='lg:col-span-4'>
                <StyleTwoCard Data={Data.rss_feeds_news[2]} middleCard={true} breakingNewsCard={true} rssFeedCard={true} />
              </div>
              <div className='grid lg:grid-cols-1 gap-5 lg:col-span-2'>
                <>
                  <StyleTwoCard Data={Data.rss_feeds_news[3]} breakingNewsCard={true} rssFeedCard={true} />
                  <StyleTwoCard Data={Data.rss_feeds_news[4]} breakingNewsCard={true} rssFeedCard={true} />
                </>
              </div>
            </div>
