            ...
            <div className="">
              ...
              >
                {Data?.videos?.slice(0, 3).map((item, index) => (
                  <SwiperSlide key={index} className='pb-14 sm:pb-16'>
      ...
      <>
        {
          ...
          <div className='styleOne'>
            ...
            <div className="">
              ...
              >
                {Data.rss_feeds_news.slice(0, 3).map((item, index) => (
                  <SwiperSlide key={index} className='pb-14 sm:pb-16'>
                    <StyleOneCard item={item} breakingNewsSect={true} rssFeedCard={true}/>
                  </SwiperSlide>
                ))}
              </Swiper>
            </div>
