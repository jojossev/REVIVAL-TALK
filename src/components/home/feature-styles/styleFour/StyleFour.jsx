...
const StyleFour = ({ Data }) => {
  ...
  return (
    ...
    <>
      ...
      {/* rss-feeds-news starts from here  */}
      <>
        {Data && Data.rss_feeds_news?.length > 0 &&
          ...
          <div className='styleFour container'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {
                Data && Data.rss_feeds_news?.map((item, index) => (
                  <div key={index}>
                    <StyleFourCard value={item} breakingNewsSect={true} rssFeedCard={true} />
                  </div>
                ))
