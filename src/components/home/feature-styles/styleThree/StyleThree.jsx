...
const StyleThree = ({ Data }) => {
  ...
  return (
    ...
    <>
      ...
      {/* rss-feeds-news section starts */}
      {Data && Data.rss_feeds_news?.length > 0 && <section className='styleThree container'>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
          ...
          <div className="relative col-span-6">
            <StyleThreeCardOne Data={Data?.rss_feeds_news[0]} breakingNewsCard={true} rssFeedCard={true}/>
          </div>

          <div className="col-span-6 flex flex-col gap-5">
            <>
              <StyleThreeCardTwo Data={Data?.rss_feeds_news[1]} sideCards={true} breakingNewsCard={true} rssFeedCard={true}/>
              <StyleThreeCardTwo Data={Data?.rss_feeds_news[2]} sideCards={true} breakingNewsCard={true} rssFeedCard={true}/>
            </>
