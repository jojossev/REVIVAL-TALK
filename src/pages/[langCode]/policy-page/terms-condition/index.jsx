...
if (process.env.NEXT_PUBLIC_SEO === "true") {
  serverSidePropsFunction = async (context) => {
    ...
    const currentURL = process.env.NEXT_PUBLIC_WEB_URL + `/${language_code}/policy-page/terms-condition`;

    const seoData = await fetchDataFromSeo('terms-condition', language_code);
