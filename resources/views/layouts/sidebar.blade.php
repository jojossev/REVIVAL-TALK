    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            'news-clone','news-delete', 'news-bulk-delete', 'breaking-news-list', 'breaking-news-create', 'breaking-news-edit', 'breaking-news-delete', 'breaking-news-bulk-delete', 'live-streaming-list', 'live-streaming-create', 'live-streaming-edit', 'live-streaming-delete', 'rss-list', 'rss-create', 'rss-edit', 'rss-delete', 'rss-bulk-delete']) --}}
                ...
                @endcanany
                @canany(['enews-list', 'enews-create', 'enews-edit', 'enews-delete'])
                <li class="nav-item">
                    <a href="{{ route('e-news.index') }}" class="nav-link {{ $currentUrl == route('e-news.index') ? 'active' : '' }}">
                ...
                @endcanany
                @canany(['author-list', 'author-edit'])
                <li class="nav-item">
                    <a href="{{ route('author.index') }}"
                        class="nav-link {{ $currentUrl == route('author.index') ? 'active' : '' }}">
