...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(url(Storage::url($setting['app_logo']))); ?>" />
    <title> <?php echo e(__('login')); ?> || <?php echo e($setting['app_name']); ?></title>
            ...
            <div class="card-body login-card-body">
                <div class="login-logo">
                    <a href="javascript:void(0)">
                        <img src="<?php echo e(url(Storage::url($setting['app_logo_full']))); ?>" alt="image" width="200" />
                    </a>
                </div>

                <h3 class="login-box-title">Welcome!</h3>
                <p class="login-box-msg">Please Login to your Account</p>
                <form role="form" id="login_form" action="<?php echo e(route('authenticate')); ?>" novalidate method="post">
                    <?php echo csrf_field(); ?>
                    <div class="form-group inner-addon left-addon">
                        <i class="fa fa-user"></i>
                        <input type="text" name="username" class="form-control" <?php if(env('DEMO_MODE')): ?> value="admin" <?php endif; ?> placeholder="Username or Email" else placeholder="Email or Username" required>
                    </div>
                    <div class="form-group inner-addon left-addon">
                        <i class="fa fa-lock"></i>
                        <input id="password" type="password" name="password" class="form-control" <?php if(env('DEMO_MODE')): ?> value="admin123" <?php endif; ?> placeholder="Password" required>
                        <i class="fa fa-eye password-toggle" id="eye-icon" onclick="togglePasswordVisibility()"></i>
                    </div>
                    
                    <?php if(session('error')): ?>
                        <div class="row col-12">
                            <p id="error_msg" class="alert alert-danger"><?php echo e(session('error')); ?></p>
                        </div>
                    <?php endif; ?>
                    <div class="row">
                        <div class="col-12">
...
<?php /**PATH /var/www/admin/resources/views/auth/login.blade.php ENDPATH**/ ?>