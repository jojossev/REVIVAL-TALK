...
Route::post('get_rss_feed', [ApiController::class, 'getRssFeed']); // getting all rss sources data
...
Route::group(['middleware' => ['auth.optional']], function () {
    ...
    // get all authors news
    Route::get('get_authors_news/{author_id}', [ApiController::class, 'getAuthorsNews']);
...
// Route::post('register_device_token', [ApiController::class, 'registerDeviceToken']);
...
Route::group(['middleware' => ['auth:sanctum', 'sanitize']], function () {
    ...
    // become author route
    Route::post('become_author', [ApiController::class, 'becomeAuthor']);

    Route::post('update_author_profile', [ApiController::class, 'updateAuthorProfile']);

    // getting user (Author) drafted news
    Route::post('get_user_drafted_news', [ApiController::class, 'getUserDraftedNews']);

    // create tags for news
    Route::post('create_tag', [ApiController::class, 'createTag']);


});
/** E news */
Route::post('get_e_news', [ApiController::class, 'getENews']);

// get feeds items from rss source
Route::post('get_feed_items', [ApiController::class, 'getFeedItems']);
